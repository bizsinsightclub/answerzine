 ...
 *
 * 2026-08-13 네 번째 개정 — 사용자가 기존 사실 관계 문단(선정 기준·데이터 출처·
 * 발행 주기, "순위는 결과다..." 세 문단)을 삭제해 달라고 직접 요청해 그대로
 * 지웠다. 그 문단들을 WHY ANZINE과 나누던 괘선(.about-mechanics, css.mjs)도
 * 감쌀 내용이 없어져 함께 뺐다 — design.md의 해당 절도 갱신했다.
 */
